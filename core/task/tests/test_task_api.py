...
class TestPostAPi:
    ...
    def test_get_task_list_verified_user_response_200_status(
    ...
    def test_get_task_list_unverified_user_response_403_status(
    ...
    def test_get_task_detail_response_200_status(
        self, api_client, task_obj, user_verified
    ):
        """
    ...
    def test_update_task_detail_response_200_status(
        self, api_client, task_obj, user_verified
    ):
        """
        ...
        """
        url = reverse("task:api-v1:task-detail", kwargs={"pk": task_obj.id})
        data = {"title": "test_title", "content": "description"}
        api_client.force_authenticate(user=user_verified)
        response = api_client.put(url, data, format="json")
        assert response.status_code == 200

    def test_delete_task_detail_response_204_status(
        self, api_client, task_obj, user_verified
    ):
        """
    ...
    def test_get_done_task_response_200_status(
        self, api_client, task_obj, user_verified
    ):
        """
