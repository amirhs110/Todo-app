...
class TestAccountsJwtAuth:
    ...
    def test_jwt_refresh_verified_user_response(self,api_client,user_verified,jwt_refresh_token):
    ...
    def test_jwt_verify_user_response(self,api_client,user_verified,jwt_refresh_token):
        token = jwt_refresh_token
