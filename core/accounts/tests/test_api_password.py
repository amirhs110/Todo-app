...
class TestAccountsPassword:
    ...
    def test_reset_password_verified_user_response_200_status(self,api_client,user_verified):
    ...
    def test_reset_password_unverified_user_response_400_status(self,api_client,user_common):
        url = reverse('accounts:reset-password')
        data = {
    ...
    def test_reset_password_confirm_response_200_status(self, api_client, jwt_refresh_token):
        ...
        data = {
            'new_password' : '123456789@mir',
            're_new_password' : '123456789@mir'
        }
